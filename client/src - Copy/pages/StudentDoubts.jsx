...
const StudentDoubts = () => {
    ...
    // Usually we would filter by current student, but we just show all mock queries here for demo
    const myQueries = queries.filter(q => q.studentName === "Current User" || q.studentName.includes("Richard"))
