                    ...
                    <tr key={index} className='hover:bg-gray-50/50 transition-colors'>
                      <td className='py-4 px-6 flex items-center gap-3'>
                        <div className='p-2 bg-gray-50 rounded-lg border border-gray-100'>
                          <img className='w-6 h-6 object-contain' src={job.logo} alt="" />
                        </div>
                        <span className='font-medium text-gray-800'>{job.company}</span>
                      </td>
                      <td className='py-4 px-6 text-gray-600 font-medium'>{job.title}</td>
                      ...
                      <td className='py-4 px-6'>
                        ...
                        >
                          {job.status === 'Pending' ? <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mr-1.5 animate-pulse"></span> : null}
                          {job.status}
                        </span>
                      </td>
                    </tr>
