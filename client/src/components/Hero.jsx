      ...
      >
        <div className='flex flex-col md:flex-row items-center justify-between gap-6'>
          ...
          <div className='flex items-center justify-center gap-8 md:gap-12 flex-wrap opacity-70 grayscale hover:grayscale-0 transition-all duration-500'>
            ...
            {[assets.microsoft_logo, assets.hero_logo, assets.tcs_logo, assets.amazon_logo, assets.adobe_logo].map((logo, i) => (
              <div key={i} className="h-10 w-24 flex items-center justify-center">
                <img
                  src={logo}
          ...
          {/* <div className='flex items-center justify-center gap-8 md:gap-12 flex-wrap opacity-70 grayscale hover:grayscale-0 transition-all duration-500'>
            ...
            <img className='h-6 scale-125 object-contain hover:scale-150 transition-transform' src={assets.hero_logo} alt="Hero" />
            <img className='h-6 object-contain hover:scale-110 transition-transform' src={assets.tcs_logo} alt="TCS" />
